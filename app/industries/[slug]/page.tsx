...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: o.metaTitle,
      description: o.metaDescription,
      url: `https://medbpo360.com/industries/${slug}`,
    },
    alternates: { canonical: `https://medbpo360.com/industries/${slug}` },
  };
}
...
export default async function IndustryPage({
  ...
  const relatedPosts = getPostsForIndustry(slug);
      ...
      <main>
        ...
        <section style={{ padding: "0 24px", background: "#fff" }}>
          <div style={{ maxWidth: 800, margin: "0 auto" }}>
            <div style={{
              display: "grid",
              gridTemplateColumns: `repeat(${o.stats.length}, 1fr)`,
              ...
              {o.stats.map(({ value, label }, i) => (
                <div key={label} style={{
                  ...
                  borderRight: i < o.stats.length - 1 ? "1px solid #e8e8ed" : "none",
                }}>
        ...
        <section style={{ padding: "20px 24px 80px", background: "#fff" }}>
          <div style={{ maxWidth: 740, margin: "0 auto", textAlign: "center" }}>
            <p style={{ fontSize: 18, color: "#3a3a3f", lineHeight: 1.8 }}>{o.description}</p>
          </div>
        </section>
          ...
          <div style={{ maxWidth: 1080, margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              <h2 style={{ fontSize: "clamp(26px, 4vw, 44px)", fontWeight: 700, letterSpacing: "-1.5px", color: "#0a0a0f", lineHeight: 1.1 }}>
                What we see across {o.name.toLowerCase()}
              </h2>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24 }}>
              {o.challenges.map((c, i) => (
                <div key={i} style={{
          ...
          <div style={{ maxWidth: 1080, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 60, alignItems: "start" }}>
            <div>
              ...
              <h2 style={{ fontSize: "clamp(26px, 4vw, 42px)", fontWeight: 700, letterSpacing: "-1.5px", color: "#0a0a0f", lineHeight: 1.1, marginBottom: 20 }}>
                Built for how<br /><span style={{ color: "#17a673" }}>{o.name.toLowerCase()} actually operate.</span>
              </h2>
              <p style={{ fontSize: 16, color: "#515154", lineHeight: 1.75, marginBottom: 32 }}>
                A dedicated implementation team, standardized processes, and executive reporting — tailored to how {o.name.toLowerCase()} actually run.
              </p>
              <Link href="/contact" style={{
        ...
        {relatedPosts.length > 0 && (
          <section style={{ padding: "80px 24px", background: "#f5f5f7" }}>
            <div style={{ maxWidth: 1140, margin: "0 auto" }}>
              <p style={{ fontSize: 12, fontWeight: 600, color: "#17a673", textTransform: "uppercase", letterSpacing: 1.5, marginBottom: 28 }}>
                From the Blog
              </p>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24 }}>
